...
public class Multiplication extends Base implements IOnAreaTouchListener, IOnSceneTouchListener
{
	...
	private void Environment()
	{
		...
		tTitle = new Text(120, 80, _Resources._OswaldLightLargeF, "Умножение", _VBO);
	...
	private void Generate()
	{
		...
		iFirst = (int)(Math.random() * (Correct * 2 + 1));
		iSecond = (int)(Math.random() * (Correct * 2 + 1));
		...
		final Rectangle Button = new Rectangle(x, y, w, h, _VBO)
		{
			public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY)
			{
				if(pSceneTouchEvent.isActionDown())
				{
					...
					{
						Uri URL = Uri.parse("https://ru.wikipedia.org/wiki/%D0%A3%D0%BC%D0%BD%D0%BE%D0%B6%D0%B5%D0%BD%D0%B8%D0%B5");
	...
	@Override public SceneType getSceneType(){return SceneType.MULTIPLICATION;}
