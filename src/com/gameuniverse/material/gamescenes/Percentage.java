...
public class Percentage extends Base implements IOnAreaTouchListener, IOnSceneTouchListener
{
	...
	private void Environment()
	{
		...
		tTitle = new Text(120, 80, _Resources._OswaldLightLargeF, "Проценты", _VBO);
	...
	private void Generate()
	{
		...
		iFirst = (int)(Math.random() * Correct);
		iFirst = iFirst * (int)(Math.random() * 100);
		iSecond = (int)(Math.random() * 101);
		iResult = iFirst * iSecond / 100;
		...
		final Rectangle Button = new Rectangle(x, y, w, h, _VBO)
		{
			public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY)
			{
				if(pSceneTouchEvent.isActionDown())
				{
					...
					{
						Uri URL = Uri.parse("https://ru.wikipedia.org/wiki/%D0%9F%D1%80%D0%BE%D1%86%D0%B5%D0%BD%D1%82");
	...
	@Override public SceneType getSceneType(){return SceneType.PERCENTAGE;}
