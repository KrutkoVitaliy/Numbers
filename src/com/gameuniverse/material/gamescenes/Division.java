...
public class Division extends Base implements IOnAreaTouchListener, IOnSceneTouchListener
{
	...
	private void Environment()
	{
		...
		tTitle = new Text(120, 80, _Resources._OswaldLightLargeF, "Δελενθε", _VBO);
	...
	private void Generate()
	{
		...
		iSecond = (int)(Math.random() * (Correct * 4 + 1));
		iFirst =  iSecond * (int)(Math.random() * iSecond + 1);
		...
		final Rectangle Button = new Rectangle(x, y, w, h, _VBO)
		{
			public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY)
			{
				if(pSceneTouchEvent.isActionDown())
				{
					...
					{
						Uri URL = Uri.parse("https://ru.wikipedia.org/wiki/%D0%94%D0%B5%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5_(%D0%BC%D0%B0%D1%82%D0%B5%D0%BC%D0%B0%D1%82%D0%B8%D0%BA%D0%B0)");
	...
	@Override public SceneType getSceneType(){return SceneType.DIVISION;}
