...
public class Integrals extends Base implements IOnAreaTouchListener, IOnSceneTouchListener
{
	...
	private void Environment()
	{
		...
		tTitle = new Text(120, 80, _Resources._OswaldLightLargeF, "Интегрирование", _VBO);
		tTitle.setHorizontalAlign(HorizontalAlign.CENTER);
		attachChild(tTitle);
		
		Task1 = new Sprite(40, 350, _Resources.Calc[6], _Resources._VBO);
		Task2 = new Sprite(40, 350, _Resources.Calc[7], _Resources._VBO);
		Task3 = new Sprite(40, 350, _Resources.Calc[8], _Resources._VBO);
		...
		Result1 = new Rectangle(38, 884, 640, 70, _VBO)
		{
			public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY)
			{
				...
				{
					Uri URL = Uri.parse("http://lifexperience.ru/Numbers/Integrals/3_1.PNG");
		...
		Result2 = new Rectangle(38, 884, 640, 70, _VBO)
		{
			public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY)
			{
				if(pSceneTouchEvent.isActionDown())
				{
					Uri URL = Uri.parse("http://lifexperience.ru/Numbers/Integrals/3_2.PNG");
					Intent LINK = new Intent(Intent.ACTION_VIEW, URL);
					_Activity.startActivity(LINK);
					return true;
				}
		...
		Result3 = new Rectangle(38, 884, 640, 70, _VBO)
		{
			public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY)
			{
				if(pSceneTouchEvent.isActionDown())
				{
					Uri URL = Uri.parse("http://lifexperience.ru/Numbers/Integrals/3_3.PNG");
					Intent LINK = new Intent(Intent.ACTION_VIEW, URL);
					_Activity.startActivity(LINK);
					return true;
				}
		...
		final Rectangle Button = new Rectangle(x, y, w, h, _VBO)
		{
			public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY)
			{
				if(pSceneTouchEvent.isActionDown())
				{
					...
					{
						Uri URL = Uri.parse("https://ru.wikipedia.org/wiki/%D0%98%D0%BD%D1%82%D0%B5%D0%B3%D1%80%D0%B0%D0%BB");
						Intent LINK = new Intent(Intent.ACTION_VIEW, URL);
						_Activity.startActivity(LINK);
					}
					else if(v == 1)
	...
	@Override public SceneType getSceneType(){return SceneType.INTEGRALS;}
